      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
           ...
           <p>
              <img src="{{ $blogDetail->link_image }}" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="{{ asset('img/image_1.jpg') }}" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="{{ asset('img/image_2.jpg') }}" alt="" class="img-fluid">
            </p>
            ...
            <div class="about-author d-flex">
              <div class="bio align-self-md-center mr-5">
                <img src="{{ asset('img/person_4.jpg') }}" alt="Image placeholder" class="img-fluid mb-4">
              </div>
